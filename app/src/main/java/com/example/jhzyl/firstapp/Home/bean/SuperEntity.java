...
public class SuperEntity {
    public static final int BigItemType = 0, MiddleItemType = 1, SmallItemType = 2, MaxSmallItemType = 3;
    private int pos;
    private int type;
    ...
    private static SuperEntity getType3(int pos) {
        return new SuperEntity(pos, MaxSmallItemType);
    }
    //-----------------------------------------end--------------------------------------------------
